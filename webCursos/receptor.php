...
$pdt_identity_token = 'oJULxp3lJo_Xz5-tbkvqAZZtEg69OmsPwOPDw9COpFFwgCd1X0whBg04XOO';
...
if (strcmp($lines[0], "SUCCESS") == 0) {
    ...
    //echo "FAIL";
    echo "<h1>¡Hemos procesado tu pago exitosamente!</h1> 
        Vuelve a comprar dando clic <a href='http://localhost/ProyectoFBDM-main/'>aquí</a>";
    return;
}