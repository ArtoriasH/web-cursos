...
<html lang="en">
    ...
    <body>
        ...
        <!-- HERO -->
        <div style="background: #fff;margin-bottom: 190px;">
            <div style="background: #5d1b8f;height: 85px;font-family: 'Abril Fatface', serif;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div>
                            <h2 class="text-center" style="margin-bottom: 40px;">Gestión de Usuarios</h2>
                        </div>            
                        <ul class="list-group">
                            <?php 
                                foreach($dataUsers as $rowUsers){
                            ?>
                                <form method="post" action="includes/actions.php">  
                                    <li class="list-group-item">
                                        <div class="row">
                                            <input name="idUser" type="hidden" value="<?php echo $rowUsers["idUser"]?>">
                                            <div class="col">
                                                <span><?php echo $rowUsers["nombre"]." ".$rowUsers["apeP"]." ".$rowUsers["apeM"] ?></span>
                                            </div>
                                            <div class="col d-xxl-flex justify-content-xxl-end">                                  
                                                <div class="form-check">
                                                <?php 
                                                    if($rowUsers["estado"]==1){
                                                ?>
                                                    <button name="btn-disable" class="btn btn-primary d-block w-100" type="submit"style="background:#730826; border:none; color:white; text-align:center;">
                                                        Deshabilitar
                                                    </button>
                                                <?php 
                                                    }
                                                ...
                                                ?> 
                                                    <button name="btn-enable" class="btn btn-primary d-block w-100" type="submit"style="background:#0f7370; border:none; color:white; text-align:center;">
                                                        Habilitar
                                                    </button>
                                                <?php   
                                                    }
                    ...
                    <div class="col-md-6">
                        <div>
                            <h2 class="text-center" style="">Categorias</h2>
                            <div class="text-center">
                            <input type="text" id="nombreCategoria" name="nombreCategoria" placeholder="Agregar categoría"> 
                            <input type="text" id="descripcionCategoria" name="descripcionCategoria" placeholder="Agregar descripcion">
                            <a href="" onclick="agregarCategorias()" type="submit" style="color: #bd66c4;font-size: 18px;margin: 5px;padding: 5px;"> <i class="fas fa-plus"></i></a>                         
                            </div>
                        </div>                    
                        <?php 
                            foreach($dataCategory as $rowCategory){
                        ?>
                            <div style="display:flex; flex-direction:row; border:solid 1px #5d1b8f; border-radius: 5px;justify-content: space-around; margin-bottom: 1%;">                    
                                <div style="background:#5d1b8f; width:25%;border-radius: 3px 0 0 3px;">                           
                                    <?php echo "<p style='font-weight: bold; color:#fff; margin-left:7%;'>".$rowCategory['nombreCat']."</p>";?>
                                </div>
                                <div style="width:75%;">                           
                                    <?php echo "<p style='margin-left:2%;'>".$rowCategory['descripcionCat']."</p>";?>
                                </div>
                            </div>
                        <?php 
                            }                                          
