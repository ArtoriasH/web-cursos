...
<html lang="en">
    ...
    <body>
        ...
        <div class="contenedor" style="display:flex; flex-direction:column; justify-content:center; align-items:center; padding:5%;">
            <div class="gray-container-wth-rows" style="width:40%; padding:2%; margin:0 0 2% 0;">
                <div class="card-header">
                    <h3>Pago con tarjeta</h3>
                </div>
                <div class="card-body">
                    <form id="payment-form" action="includes/actions.php" method="POST">
                        <input type="hidden" name="idCompra" value="<?php echo $_GET['idCompra']?>">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    <label class="form-label" for="cardNumber">Número de tarjeta</label>
                                    <div class="input-group">
                                        <input class="form-control" type="text" required placeholder="Número de tarjeta">
                        ...
                        <div class="row">
                            <div class="col-7">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" type="text" required placeholder="MM/YY">
                                </div>
                            </div>
                            <div class="col-5 pull-right">
                                <div class="form-group mb-3">
                                    <label class="form-label" for="cardCVC">Código CV</label>
                                    <input class="form-control" type="text" required placeholder="CVC">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <button name="btn-PaymentMethod" class="btn btn-success btn-lg d-block w-100" type="submit" style="background:#6d28aa; border:none; border-radius:5px;">
                                    Completar Pago
                                </button>
                            </div>
                        </div>
            ...
            <div class="gray-container-wth-rows" style="width:40%; padding:2%; margin:0 0 2% 0;">
                ...
                <div class="card-body">
                    <form id="payment-form" action="misCursos.php">
                        <div class="row">
                            <div class="col-12">
                                <button name="btn-PaymentMethod" class="btn btn-success btn-lg d-block w-100" type="submit" style="background:#6d28aa; border:none; border-radius:5px;">
                                    Completar Pago
