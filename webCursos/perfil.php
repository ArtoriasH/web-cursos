<?php
    ...
    $dataUser = $tempData->bringUser($_SESSION['id']); 
    $dataAllInstructorCourses = $tempData->bringAllInstructorCourses($_SESSION['id']); 
    //print_r($dataUser);
?>
<script>
...
<html lang="en">
    <head>
        ...
        <!-- Titulo -->
        <title><?php echo $dataUser['nombre']?></title>
        <!-- Favicon -->
    ...
    <body>
        ...
        <section class="py-4 py-xl-5">
            <div class="container">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-6 col-xl-4">
                        <div class="card mb-5" style="border:none;">
                            <div class="card-body d-flex flex-column align-items-center" style="border: solid 1px #c6aadb; border-radius: 6px;">
                                <div>
                                    <img src="data:image/jpeg/png;base64,<?php echo base64_encode($dataUser['foto'])?>" style="width:100px; height:100px; border-radius:75px; padding:5px; background:rgba(255,255,255,0.36); border-width:0px; border-color:#f8b9fd; margin: 5px;">
                                </div>
                                <form class="text-center" method="post" action="includes/actions.php" enctype="multipart/form-data">
                                    <input name="idUser" type="hidden" value="<?php echo $dataUser['idUser']?>">                                
                                    <div class="mb-3">
                                        <small>Correo</small>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="passInput" name="password" type="password" name="password" value="<?php echo $dataUser['contra']?>">
                                        <label>Mostrar contraseña</label>
                                        <input type="checkbox" onclick="showPassFunction()">
                                    </div>
                                    <div class="mb-3">
                                        <small>Nombre</small><input class="form-control" name="nombre" type="text" value="<?php echo $dataUser['nombre']?>">
                                    </div>
                                    <div class="mb-3">
                                        <small>Apellido Paterno</small>
                                        <input class="form-control" name="apeP" type="text" value="<?php echo $dataUser['apeP']?>">
                                    </div>
                                    <div class="mb-3">
                                        <small>Apellido Materno</small>
                                        <input class="form-control" name="apeM" type="text" value="<?php echo $dataUser['apeM']?>">
                                    </div>
                                    <div class="mb-3">
                                        <small>Fecha de Nacimiento</small>
                                        <input class="form-control" name="fNacimiento" type="date" value="<?php echo $dataUser['fNacimiento']?>">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <small>Genero</small>
                                        <?php 
                                            if($dataUser['genero'] == 0){
                                                echo "<p>Masculino</p>";
                                            }
                                            if($dataUser['genero'] == 1){
                                                echo "<p>Femenino</p> ";
                                            }
                                        ?>
                                    </div>  
                                    <div class="mb-3">
                                        <small>Vocacion</small>
                                        <?php 
                                            if($dataUser['rol'] == 0){
                                    ...
                                    <div class="mb-3">
                                        <button class="btn btn-primary d-block w-100" name="btn-updateUser" type="submit" style="background: #6d28aa;border: none;color: white; text-align: center;">
                                            Guardar Cambios
                                        </button>
                                    </div>
                                </form>
                ...
                <?php
                        if($_SESSION['tipo'] == 1){
                            echo "<h2> Cursos Creados </h2>";
                        foreach($dataAllInstructorCourses as $rowCourses){
                    ?>
                        <a href="curso.php?idCourse=<?php echo($rowCourses["idCurso"])?>" style='text-decoration: none;font-weight: bold;color: #5d1b8f'>
                            <h4 class="card-text"><?php echo $rowCourses['nombreCurso'] ?></h4>
                        </a>
                    <?php
                    }    
                    }
