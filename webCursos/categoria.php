<?php
    ...
    $dataCategories = $tempData->bringSingleCategory($_GET['idCategory']);
    $dataCategory = $tempData->bringCategory($_GET['idCategory']);
...
<html lang="en">
    <head>
        ...
        <!-- Titulo -->
        <title>Categoría: <?php echo $dataCategory['nombreCat']?></title>
        <!-- Favicon -->
    ...
    <!--NavBar-->
        ...
        <div style="background: #5d1b8f;height: 85px;">
                <div class="row d-xxl-flex">
                    <div class="col">
                        <h1 class="d-xxl-flex justify-content-xxl-center align-items-xxl-center" style="color:#fff; padding:0.4% 0 0 0; margin: 0">
                            <?php echo $dataCategory['nombreCat']?>
                        </h1>
                        <p style="color:#fff; text-align: center; padding: 0; margin: 0;"><?php echo $dataCategory['descripcionCat']?></p>
                    </div>
                </div>
            </div>
        ...
        <div style="margin-top: 26px;">
            <div class="container">
                <div class="row" style="display:flex; flex-wrap:wrap; justify-content:space-evenly;">
                    <?php 
                        foreach($dataCategories as $rowCursosConCat){
                    ?>
                        <div style="height:15%; width:15%; background-color:#f2f2f2; margin:1%; padding:1%; border-radius:5px; display:flex; flex-direction:column; justify-content:center; align-items:center;">
                            <a href="curso.php?idCourse=<?php echo($rowCursosConCat["idCurso"])?>">
                                <img src="data:image/jpeg/png;base64,<?php echo base64_encode($rowCursosConCat['imagen'])?>" style="height:150px; width:150px; border-radius:5px;">
                            </a>
                            <div class="card-body">
                                <a href="curso.php?idCourse=<?php echo($rowCursosConCat["idCurso"])?>" style="text-decoration:none; font-weight:bold; color:#5d1b8f">
                                    <p class="card-text"><?php echo($rowCursosConCat["nombreCurso"])?></p>
                                </a>
                            </div>
                        </div>        
                    <?php
        ...
        <!-- Footer -->
        <footer class="text-center bg-dark footer" style="margin-top: 270px">
