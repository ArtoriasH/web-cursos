<?php
    ...
    $dataChats = $tempData->bringChats($_SESSION['id']);    
    ...
    <body>
        ...
        <div class="contenedor" style="display:flex; justify-content: center;">
            <div class="gray-container-center">
                <h1>Tu bandeja de entrada</h1>
                <?php
                    foreach($dataChats as $rowsChats){
                        if($rowsChats['alumno'] == $_SESSION['id']){            
                ?>
                        <div class="chats">
                            <i class="fa-regular fa-envelope" style="color: #5d1b8f; font-size: 40px; margin: 0 5%;"></i>
                            <a href="chat.php?idChat=<?php echo $rowsChats['idChat']?>" style='text-decoration:none; font-weight:bold; color:#5d1b8f;'>
                                <p style="font-size:17px;"><?php echo $rowsChats['nombreI']?></p>
                            </a>
                        </div>
                <?php
                        } 
                ...
                ?>
                        <div class="chats">
                            <i class="fa-regular fa-envelope" style="color: #5d1b8f; font-size: 40px; margin: 0 5%;"></i>
                            <a href="chat.php?idChat=<?php echo $rowsChats['idChat']?>" style='text-decoration:none; font-weight:bold; color:#5d1b8f;'>
                                <p style="font-size:17px;"><?php echo $rowsChats['nombreA']?></p>
                            </a>
                        </div>
                <?php 
                        }
        ...
        <!-- Footer -->
        <footer class="text-center bg-dark footer" style="margin-top: 419px;">
