        ...
        <div class="contenedor">
            <div style="background: #5d1b8f;height: 85px;">
                <div class="row d-xxl-flex">
                    <div class="col">
                        <a href="curso.php?idCourse=<?php echo($dataLevel["idCurso"])?>" style='text-decoration: none;'>
                            <h1 class="d-xxl-flex justify-content-xxl-center align-items-xxl-center" style="color:#fff; padding-top:15px;">
                                <?php echo $dataLevel['nombreCurso']?>
                            </h1>
                        </a>
                    </div>
                </div>
            ...
            <div style="padding:1%;">
                <div class="row">
                    <h2 style="">
                        "<?php echo $dataLevel['nombreNiv']?>"
                    </h1>
                </div>
                <div class="row" style="display:flex; justify-content:center;">
                    <video width="720" height="480" controls>
                        <source src="data:video/mp4;base64,<?php echo base64_encode($dataLevel['video'])?>" type="video/mp4">
                    </video>                             
                </div>
                <div class="row" style="padding-top:1%;">
                    <form action="includes/actions.php" method="POST">
                        <input type="hidden" name="idUser" value="<?php echo $_SESSION['id']?>">
                        <input type="hidden" name="idCurso" value="<?php echo $dataLevel['idCurso']?>">
                        <input type="hidden" name="idNivel" value="<?php echo $dataLevel['idNivel']?>">
                        <button class="btn btn-primary" name="btnUpdateProgress" type="submit" style="background:#6d28aa; border:none; color:white; text-align:center;">
                            Nivel Completado
                        </button>
                    </form>        
                </div>
